...
public class ControladorSeqboot implements ActionListener {
		...
		ControladorIGrafu.seqboot.addWindowListener(new java.awt.event.WindowAdapter() {
			public void windowClosing(WindowEvent evt) {
				...
				int opcao = JOptionPane.showOptionDialog(null, FECHAR,
						"IGRAFU 2.0", JOptionPane.YES_NO_OPTION,
	...
	/*
	 * Metodo de inicializacao de alguns parametos como:
	 * Grupos de botoes
	 * Idioma
	 * Eventos
	 */
	public void init() {
		if(Tradutor.getLinguage() == Tradutor.getENGLISH())
			ControladorIGrafu.seqboot.getJCheckBoxMenuItemIngles().setSelected(true);
		else
			ControladorIGrafu.seqboot.getJCheckBoxMenuItemPortugues().setSelected(true);


		if(ControladorIGrafu.conversor != null){
			if(ControladorIGrafu.conversor.getJTextFieldArquivoEntrada().getText() != "") {
				ControladorIGrafu.seqboot.getJTextFieldArquivoSequencia().setText(ControladorIGrafu.conversor.getJTextFieldArquivoEntrada().getText());
			}
		}
...
//		ControladorIGrafu.seqboot.getJCheckBoxMultiplosArquivosSaidaDados().setSelected(true);

		//Campo fracao de tempo da aba Consense
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource() == ControladorIGrafu.seqboot.getJButtonCategoriasSitios()) {
			if(Navegar.navegar == null) {
				...
				Navegar.navegar.abreArquivos();
				if(Navegar.getReturnVal() == JFileChooser.APPROVE_OPTION)
					ControladorIGrafu.seqboot.getJTextFieldCategoriasSitios().setText(Navegar.file.getAbsolutePath());
			}
			else {
				Navegar.navegar.abreArquivos();
				if(Navegar.getReturnVal() == JFileChooser.APPROVE_OPTION)
		...
		if (e.getSource() == ControladorIGrafu.seqboot.getJButtonPesos()) {
			if(Navegar.navegar == null) {
				...
				Navegar.navegar.abreArquivos();
				if(Navegar.getReturnVal() == JFileChooser.APPROVE_OPTION)
					ControladorIGrafu.seqboot.getJTextFieldPesos().setText(Navegar.file.getAbsolutePath());
			}
			else {
				Navegar.navegar.abreArquivos();
				if(Navegar.getReturnVal() == JFileChooser.APPROVE_OPTION)
		...
		if (e.getSource() == ControladorIGrafu.seqboot.getJButtonArquivoMisturado()) {
			if(Navegar.navegar == null) {
				...
				Navegar.navegar.abreArquivos();
				if(Navegar.getReturnVal() == JFileChooser.APPROVE_OPTION)
					ControladorIGrafu.seqboot.getJTextFieldArquivoMisturado().setText(Navegar.file.getAbsolutePath());
			}
			else {
				Navegar.navegar.abreArquivos();
				if(Navegar.getReturnVal() == JFileChooser.APPROVE_OPTION)
		...
		if (e.getSource() == ControladorIGrafu.seqboot.getJButtonArquivoAncestral()) {
			if(Navegar.navegar == null) {
				...
				Navegar.navegar.abreArquivos();
				if(Navegar.getReturnVal() == JFileChooser.APPROVE_OPTION)
					ControladorIGrafu.seqboot.getJTextFieldArquivoAncestral().setText(Navegar.file.getAbsolutePath());
			}
			else {
				Navegar.navegar.abreArquivos();
				if(Navegar.getReturnVal() == JFileChooser.APPROVE_OPTION)
		...
		if (e.getSource() == ControladorIGrafu.seqboot.getJButtonArvore()) {
			if(Navegar.navegar == null) {
				...
				Navegar.navegar.abreArquivos();
				if(Navegar.getReturnVal() == JFileChooser.APPROVE_OPTION)
					ControladorIGrafu.seqboot.getJTextFieldArvore().setText(Navegar.file.getAbsolutePath());
			}
			else {
				Navegar.navegar.abreArquivos();
				if(Navegar.getReturnVal() == JFileChooser.APPROVE_OPTION)
		...
		if(e.getSource() == ControladorIGrafu.seqboot.getJComboBoxTipoSequencia()) {
			...
			if((ControladorIGrafu.seqboot.getJComboBoxModelo().getSelectedItem() == ControladorIGrafu.seqboot.getJComboBoxModelo().getItemAt(1)) &&
					(ControladorIGrafu.seqboot.getJComboBoxTipoSequencia().getSelectedItem() == ControladorIGrafu.seqboot.getJComboBoxTipoSequencia().getItemAt(1))) {
				ControladorIGrafu.seqboot.getJButtonCategoriasSitios().setEnabled(false);
			}

			if((ControladorIGrafu.seqboot.getJComboBoxModelo().getSelectedItem() == ControladorIGrafu.seqboot.getJComboBoxModelo().getItemAt(2)) &&
					(ControladorIGrafu.seqboot.getJComboBoxTipoSequencia().getSelectedItem() == ControladorIGrafu.seqboot.getJComboBoxTipoSequencia().getItemAt(1))) {
				ControladorIGrafu.seqboot.getJButtonCategoriasSitios().setEnabled(false);
			}

			if((ControladorIGrafu.seqboot.getJComboBoxModelo().getSelectedItem() == ControladorIGrafu.seqboot.getJComboBoxModelo().getItemAt(3)) &&
					(ControladorIGrafu.seqboot.getJComboBoxTipoSequencia().getSelectedItem() == ControladorIGrafu.seqboot.getJComboBoxTipoSequencia().getItemAt(1))) {
				ControladorIGrafu.seqboot.getJButtonCategoriasSitios().setEnabled(false);
				ControladorIGrafu.seqboot.getJButtonArquivoAncestral().setEnabled(false);
				ControladorIGrafu.seqboot.getJButtonArquivoMisturado().setEnabled(false);
			...
			if((ControladorIGrafu.seqboot.getJComboBoxModelo().getSelectedItem() == ControladorIGrafu.seqboot.getJComboBoxModelo().getItemAt(4)) &&
					(ControladorIGrafu.seqboot.getJComboBoxTipoSequencia().getSelectedItem() == ControladorIGrafu.seqboot.getJComboBoxTipoSequencia().getItemAt(1))) {
				ControladorIGrafu.seqboot.getJButtonCategoriasSitios().setEnabled(false);
				ControladorIGrafu.seqboot.getJButtonArquivoAncestral().setEnabled(false);
				ControladorIGrafu.seqboot.getJButtonArquivoMisturado().setEnabled(false);
			...
			if((ControladorIGrafu.seqboot.getJComboBoxModelo().getSelectedItem() == ControladorIGrafu.seqboot.getJComboBoxModelo().getItemAt(0)) &&
					(ControladorIGrafu.seqboot.getJComboBoxTipoSequencia().getSelectedItem() == ControladorIGrafu.seqboot.getJComboBoxTipoSequencia().getItemAt(2))) {
				ControladorIGrafu.seqboot.getJButtonCategoriasSitios().setEnabled(false);
			}
			...
			if((ControladorIGrafu.seqboot.getJComboBoxModelo().getSelectedItem() == ControladorIGrafu.seqboot.getJComboBoxModelo().getItemAt(0)) &&
					(ControladorIGrafu.seqboot.getJComboBoxTipoSequencia().getSelectedItem() == ControladorIGrafu.seqboot.getJComboBoxTipoSequencia().getItemAt(3))) {
				ControladorIGrafu.seqboot.getJButtonCategoriasSitios().setEnabled(false);
			}
