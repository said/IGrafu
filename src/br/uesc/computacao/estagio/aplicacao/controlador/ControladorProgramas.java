		...
		if(e.getSource() == ControladorIGrafu.programas.getJButtonAvancar()) {
			try {
				if (ControladorIGrafu.programas.getJRadioButtonPHYML().isSelected()
						|| ControladorIGrafu.programas.getJRadioButtonDIGRAFU().isSelected()
						|| ControladorIGrafu.programas.getJRadioButtonMrBayes().isSelected()
						|| ControladorIGrafu.programas.getJRadioButtonParcimonia().isSelected()) {
					if (ControladorIGrafu.programas.getJRadioButtonPHYML().isSelected()) {
						if (ControladorIGrafu.phyml == null) {
							...
							if(Tradutor.getLinguage() == Tradutor.getENGLISH())
								ControladorIGrafu.phyml.getJCheckBoxMenuItemIngles().setSelected(true);
							else
								ControladorIGrafu.phyml.getJCheckBoxMenuItemPortugues().setSelected(true);
							...
							ControladorIGrafu.phyml.setVisible(true);
                                                ...
                                                /*Indicando que a saida deve ser phylip*/
                                               // GerarParametrosConversor.arqSaida = "phylip";
                                               // System.out.println(GerarParametrosConversor.arqSaida);
					...
					if (ControladorIGrafu.programas.getJRadioButtonDIGRAFU().isSelected()) {
						...
						if (ControladorIGrafu.digrafu == null) {
							...
							if(ControladorModoManualBootstrap.bootstrap)
								ControladorIGrafu.digrafu.getJButtonArquivoSequencia().setEnabled(false);
							else
								ControladorIGrafu.digrafu.getJButtonArquivoSequencia().setEnabled(true);

							if(Tradutor.getLinguage() == Tradutor.getENGLISH())
								ControladorIGrafu.digrafu.getJCheckBoxMenuItemIngles().setSelected(true);
							else
								ControladorIGrafu.digrafu.getJCheckBoxMenuItemPortugues().setSelected(true);*/
					...
					JOptionPane.showMessageDialog(null,	PROGRAMA_UTILIZAR, PROGRAMAS, JOptionPane.INFORMATION_MESSAGE);
			}
