...
public class ModoExecucao extends JFrame {
	...
	private JDialog jDialogSobre = null;  //  @jve:decl-index=0:visual-constraint="578,494"
	...
	private JDialog jDialogModoExecucaoPerfil = null;  //  @jve:decl-index=0:visual-constraint="83,515"
	...
	public JTextField getJTextFieldArquivoSequencia() {
		if (jTextFieldArquivoSequencia == null) {
			...
			jTextFieldArquivoSequencia.setEditable(false);
                        jTextFieldArquivoSequencia.setVisible(false);
		}
	...
	public JButton getJButtonArquivoSequencia() {
		if (jButtonArquivoSequencia == null) {
			...
			jButtonArquivoSequencia.setCursor(new Cursor(Cursor.HAND_CURSOR));
                        jButtonArquivoSequencia.setVisible(false);
		}
	...
	public ModoExecucao() {
		super();
          ...
          /*      jSeparator10.setVisible(false);
                ...
                jLabelArquivoSequencia.setVisible(false);
            */
	}
