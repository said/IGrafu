...
/*  printf("executando get_all_partial_lk_scale\n");*/
  ...
  if(d->tax) return;
	...
	(d->b[dir2]->p_lk_left);
      ...
      Pij1 = d->b[dir1]->Pij_rr;
      Pij2 = d->b[dir2]->Pij_rr;
     // printf("Pij1 = d->b[%d]->l = %lf\n",dir1, d->b[dir1]->l);
      //printf("Pij2 = d->b[%d]->l = %lf\n",dir2, d->b[dir2]->l);
		  ...
		  if(j != i)
		    {
              ...
              //  printf ("postorder:fils->b[%d]->l = %lf\n",i, fils->b[i]->l);
	      (tree->n_otu > LIM_SCALE)?
...
/* printf("valor de fim do segundo for %d\n",  tree->mod->n_catg);*/
  
  For(br,2*tree->n_otu-3) 
    {
/* printf("valor de inicio %d fim do for %d\n",br,  2*tree->n_otu-3);*/
      For(site,tree->n_pattern)
	{
      ...
      For(catg,tree->mod->n_catg)
	{
	  ...
	  if(len < BL_MIN) len = BL_MIN;
         /* printf("chamando PMat dentro de Lk\n");*/
	  PMat(len,
	       tree->mod,
...
/*  printf("executando preorder dentro de lk\n");*/
 ...
 /* if(tree->both_sides){
  ...
  tree->curr_catg =  0;
  tree->curr_site =  0;
/*printf("valor de n_pattern %d \n", tree->n_pattern);*/
  For(site,tree->n_pattern)
    {
/* printf("segundo for: valor de inicio %d e fim do for %d\n",site,  tree->n_pattern);*/
...
/*    is_ambigu = 1; */
  ...
  if (!tree->mod->invar)
	...
	+ eroot->sum_scale_f_left[site] + eroot->sum_scale_f_rght[site];
      /* printf("valor de sum_scale_f_left %lf e sum_scale_f_rigth %lf \n", eroot->sum_scale_f_left[site], eroot->sum_scale_f_rght[site]);*/
    }
  else
    {
...
/* BRENT */ /* para otimizar chama o modelo */
...
/*printf("valor de crunch_len e stepsize %d %d \n",tree->data->crunch_len, tree->mod->stepsize);*/
