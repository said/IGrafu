...
void PMat_K80(double l,double kappa, double ***Pij)
{
  ...
  if (1.0!=kappa)
    {
     /*  printf("kappa != 1, estou passando por aqui com JC69\n");*/
    ...
    {
    /*  printf("kappa = %lf, estou passando por aqui com JC69\n", kappa); */
      Ts = Tv = .25*(1-e1);
    }

/*    printf("para JC69 kappa = %lf e l = %lf\n",kappa, l); */
...
void dPMat_K80(double l, double ***dPij, double rr, double k)
{
  ...
  if (1.0!=k)
    ...
    {
    e2 = e1;
    /*printf(" para derivada: kappa = 1, estou passando por aqui com JC69\n");*/
  }

 /* printf(" para derivada: l = %lf,  rr = %lf , k = %lf\n",l, rr, k); */
